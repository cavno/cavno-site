...
export const CATEGORY_PALETTES: Record<string, { hue: number; saturation: number }> = {
  ...
  'reading:economics': { hue: 198, saturation: 24 },
  'reading:science': { hue: 178, saturation: 22 },
  'reading:management': { hue: 160, saturation: 24 },
  'investing:research': { hue: 212, saturation: 26 },
  'working:operations': { hue: 186, saturation: 22 },
  ...
  'life:places': { hue: 170, saturation: 22 },
...
export const ARTICLE_COVERS: Record<string, { motif: CoverMotif; layout?: CoverLayout }> = {
  ...
  '/reading/economics/financial-system/': { motif: 'market', layout: 'band' },
  '/reading/politics/chinese-dynasties/': { motif: 'lineage', layout: 'split' },
  '/reading/science/matter-evolution/': { motif: 'strata', layout: 'framed' },
  '/reading/science/physics-evolution/': { motif: 'spectrum', layout: 'framed' },
  '/reading/books/financial-alchemy-systems-analysis/': { motif: 'feedback', layout: 'framed' },
  '/investing/research/financial-micro-market-evolution/': { motif: 'network', layout: 'split' },
  '/reading/economics/macroeconomics-evolution/': { motif: 'timeline', layout: 'band' },
  '/reading/politics/political-science-systems-history/': { motif: 'network', layout: 'band' },
  ...
  '/reading/science/human-brain-evolution/': { motif: 'network', layout: 'framed' },
};
